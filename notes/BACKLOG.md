...
## v1.1 Fixes (from extended testing)
- [x] Fix markdown fence stripping in LLM-generated HTML/code output
- [x] Fix color adherence — brand colors now included in LLM prompts
- [x] Fix dashboard world model name overflow
- [x] Fix event detail referrer layout (full-width)
- [x] Add Method and Status to event detail view
- [x] Add seconds to event timestamps
- [x] Add Raw JSON tab to event detail
- [x] Add form placeholders to world model editor
- [x] Add file variation (document template pools, style hints, seeded RNG)
- [x] Add file verbosity and variance settings (generation_settings per world model)
- [x] Add DOCX renderer (pure Go)
- [x] Add XLSX renderer (excelize/v2)
- [x] Add Deployments system (create, start, stop, delete deployments)
...
- [x] ~~Add DOCX generation~~ (moved to v1.1)
- [x] ~~Add XLSX generation~~ (moved to v1.1)
